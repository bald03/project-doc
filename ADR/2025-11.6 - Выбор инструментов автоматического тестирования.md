...
**Контекст**  
Система микросервисная (ADR 2025-11.1). Серверная часть — C# / .NET (ADR 2025-11.2). Клиент — React + React Native (ADR 2025-11.3). Нужна унифицированная стратегия автоматического тестирования с интеграцией в CI/CD.
...
**Связанные ADR**  
- ADR 2025-11.1 — Архитектурная форма (микросервисы)  
- ADR 2025-11.2 — Технология серверной части (C# / .NET)  
- ADR 2025-11.3 — Технология клиентского приложения (React / React Native)
