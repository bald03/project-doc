...
**Контекст:**  
Система спроектирована как набор микросервисов (см. ADR 2025-11.1). Для клиентской части нужно выбрать технологию, которая обеспечит лучший UX, быструю разработку и поддержку веб, Android и iOS‑платформ. Важны безопасность (авторизация через identity provider), интеграция с API серверной части (C# / .NET, ADR 2025-11.2) и возможность переиспользования кода между платформами.
