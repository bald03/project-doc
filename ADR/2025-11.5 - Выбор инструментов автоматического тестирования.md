...
**Последствия:**  
- Ввести стандартизованные шаблоны тестовых проектов и CI‑workflow.  
- Настроить публикацию артефактов (coverage, pact, тест‑результаты, скриншоты/видео).  
- План обучения команд и пилотный запуск на одном backend и frontend модуле.  
- Метрики надёжности тестов (flakiness) и политика обработки flaky‑тестов.
